  ...
  return (
    <section className="relative flex min-h-screen items-center pb-20 pt-32 md:pt-36">
      <div className="section-shell">
        <div className="mx-auto grid max-w-6xl items-center gap-8 lg:grid-cols-[1.16fr_0.84fr]">
          <motion.div
          ...
          >
            ...
            <p className="mt-6 max-w-2xl text-balance text-base text-foreground/74 md:text-lg">
              I design and build full-stack products that are fast, clear, and memorable. From idea to launch, I focus on
              experiences that feel smooth in every interaction.
            </p>
          ...
          <motion.aside
            ...
            className="glass-card-strong relative overflow-hidden p-6 md:p-7"
          >
